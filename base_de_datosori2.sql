...
-- Volcando estructura de base de datos para ori2
...
-- Volcando estructura para tabla ori2.convocatoria
...
-- Volcando datos para la tabla ori2.convocatoria: ~0 rows (aproximadamente)
DELETE FROM `convocatoria`;

-- Volcando estructura para tabla ori2.convocatoria_convocatorias_subprogramas
...
-- Volcando datos para la tabla ori2.convocatoria_convocatorias_subprogramas: ~0 rows (aproximadamente)
DELETE FROM `convocatoria_convocatorias_subprogramas`;

-- Volcando estructura para tabla ori2.departamento
...
-- Volcando datos para la tabla ori2.departamento: ~0 rows (aproximadamente)
DELETE FROM `departamento`;

-- Volcando estructura para tabla ori2.file
...
-- Volcando datos para la tabla ori2.file: ~1 rows (aproximadamente)
DELETE FROM `file`;
INSERT INTO `file` (`id`, `file`, `file_proyecto_id_id`) VALUES
	(1, 'archivos/Ángel_ORLA.png', 1);

-- Volcando estructura para tabla ori2.institucion
...
-- Volcando datos para la tabla ori2.institucion: ~2 rows (aproximadamente)
DELETE FROM `institucion`;
INSERT INTO `institucion` (`id`, `nombreinstitucion`, `email`, `pais`) VALUES
	(1, 'UGR', 'ugr@correo.ugr.es', 'spain'),
	(2, 'Guadix', NULL, NULL);

-- Volcando estructura para tabla ori2.participante
...
-- Volcando datos para la tabla ori2.participante: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla ori2.participante_proyectos
...
-- Volcando datos para la tabla ori2.participante_proyectos: ~0 rows (aproximadamente)
DELETE FROM `participante_proyectos`;
INSERT INTO `participante_proyectos` (`id`, `participante_id`, `proyecto_id`) VALUES
	(2, 10, 1);

-- Volcando estructura para tabla ori2.partnership_agreement
...
-- Volcando datos para la tabla ori2.partnership_agreement: ~0 rows (aproximadamente)
DELETE FROM `partnership_agreement`;

-- Volcando estructura para tabla ori2.periodicidad
...
-- Volcando datos para la tabla ori2.periodicidad: ~0 rows (aproximadamente)
DELETE FROM `periodicidad`;
INSERT INTO `periodicidad` (`id`, `tipo_periodicidad`, `periodosanuales`, `fecha_creacion`) VALUES
	(1, 'mensual', 12, NULL);

-- Volcando estructura para tabla ori2.periodo
CREATE TABLE IF NOT EXISTS `periodo` (
  ...
  CONSTRAINT `periodo_ibfk_1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`proyecto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla ori2.periodo: ~0 rows (aproximadamente)
DELETE FROM `periodo`;

-- Volcando estructura para tabla ori2.posee
CREATE TABLE IF NOT EXISTS `posee` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `participante_id` (`participante_id`,`proyecto_id`,`timesheet_id`),
  KEY `timesheet_id` (`timesheet_id`),
  CONSTRAINT `posee_ibfk_1` FOREIGN KEY (`participante_id`, `proyecto_id`) REFERENCES `participante_proyectos` (`participante_id`, `proyecto_id`),
  CONSTRAINT `posee_ibfk_2` FOREIGN KEY (`timesheet_id`) REFERENCES `timesheet` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla ori2.posee: ~0 rows (aproximadamente)
DELETE FROM `posee`;

-- Volcando estructura para tabla ori2.presupuesto
...
-- Volcando datos para la tabla ori2.presupuesto: ~0 rows (aproximadamente)
DELETE FROM `presupuesto`;

-- Volcando estructura para tabla ori2.programa
...
-- Volcando datos para la tabla ori2.programa: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla ori2.proyecto_participa_institucion
...
-- Volcando datos para la tabla ori2.proyecto_participa_institucion: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla ori2.rol
...
-- Volcando datos para la tabla ori2.rol: ~0 rows (aproximadamente)
DELETE FROM `rol`;

-- Volcando estructura para tabla ori2.sepresenta
CREATE TABLE IF NOT EXISTS `sepresenta` (
  ...
  `proyecto_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `convocatoria_id` (`convocatoria_id`,`subprograma_id`,`proyecto_id`),
  KEY `proyecto_id` (`proyecto_id`),
  CONSTRAINT `sepresenta_ibfk_1` FOREIGN KEY (`convocatoria_id`, `subprograma_id`) REFERENCES `convocatoria_convocatorias_subprogramas` (`convocatoria_id`, `subprograma_id`),
  CONSTRAINT `sepresenta_ibfk_2` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`proyecto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla ori2.sepresenta: ~0 rows (aproximadamente)
DELETE FROM `sepresenta`;

-- Volcando estructura para tabla ori2.subprograma
CREATE TABLE IF NOT EXISTS `subprograma` (
  ...
  KEY `hijosubprograma_id` (`hijosubprograma_id`),
  KEY `hijoprograma_id` (`hijoprograma_id`),
...
-- Volcando datos para la tabla ori2.subprograma: ~0 rows (aproximadamente)
DELETE FROM `subprograma`;

-- Volcando estructura para tabla ori2.timesheet
...
-- Volcando datos para la tabla ori2.timesheet: ~0 rows (aproximadamente)
